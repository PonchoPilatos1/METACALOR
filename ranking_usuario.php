...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/banner-4.jpeg" alt="Image" style="height: 1000px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h1 class="text-white display-3 mt-lg-5 py-4">Ranking Global🏅</h1>
    ...
    <br><br><br><a href="ranking_usuario.php"  class="btn btn-primary py-4 px-6" style="margin-left:44%;" >- Actualizar -</a><br><br><br><br>
