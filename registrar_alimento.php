    ...
    <script>
        $(document).ready(function(){
            $("#busqueda").on("input", function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "controlador_agregarComida.php",
    ...
    <div class="container-fluid p-0 mb-5 pb-5">
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            ...
            if (isset($_SESSION["username"])) {
                ...
                $id = $_SESSION["user_id"];
                echo "<h1 class='text-white display-3 mt-lg-5 py-4'>$nombreUsuario, Comiste Ya?</h1>";
        ...
        <div class="container py-3">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="section-title position-relative text-center mb-5">REGISTRA TUS ALIMENTOS</h1>
                </div>
            </div>
            <!-- Busqueda dinamica -->
                ...
                <div class="col-lg-9">
                    <div class="contact-form bg-light rounded p-5">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate"
                            action="controlador_agregarCalorias.php?id=<?php echo $id;?>" method="post" >
                            <div >
                                <label for="busqueda" class="px-3 py-2"><h2>Buscar:  </h2></label>
    ...
    <br><br>
                            <div>
                                <button class="btn btn-primary btn-block py-2 px-2" type="submit" id="sign-in"
                                    style="font-size: 20px;font-style: bold;" onclick="mostrarAlerta()">- Registrar -</button>
                            </div>

                            <script>
                                function mostrarAlerta() {
                                    if (confirm("¿Estás seguro de que deseas registrar este alimento?")) {
